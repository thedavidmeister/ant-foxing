...
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$key_DASH_value,cljs.core.cst$sym$gen_DASH_key,cljs.core.cst$sym$key_DASH_gen,cljs.core.cst$sym$gen,cljs.core.cst$sym$limit], null);
});
...
datascript.lru.LRU.cljs$lang$ctorPrWriter = (function (this__9433__auto__,writer__9434__auto__,opt__9435__auto__){
return cljs.core._write(writer__9434__auto__,"datascript.lru/LRU");
});
...
var gen = lru.gen;
var limit = lru.limit;
var temp__5276__auto__ = (key_gen.cljs$core$IFn$_invoke$arity$2 ? key_gen.cljs$core$IFn$_invoke$arity$2(k,null) : key_gen.call(null,k,null));
...
var G__25630 = datascript.lru.__GT_LRU(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_value,k,v),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(gen_key,gen,k),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(key_gen,k,gen),(gen + (1)),limit);
return (datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1 ? datascript.lru.cleanup_lru.cljs$core$IFn$_invoke$arity$1(G__25630) : datascript.lru.cleanup_lru.call(null,G__25630));
}
});
datascript.lru.cleanup_lru = (function datascript$lru$cleanup_lru(lru){
...
var gen = lru.gen;
var limit = lru.limit;
var vec__25631 = cljs.core.first(gen_key);
var g = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25631,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25631,(1),null);
