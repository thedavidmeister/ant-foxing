...
if(cljs.core.truth_((function (){var or__8762__auto__ = currency.data.currency_QMARK_(currency__$1);
...
if(cljs.core.truth_((function (){var or__8762__auto__ = coinmarketcap.ticker.data.currency_ticker_QMARK_(_PERCENT_);
if(cljs.core.truth_(or__8762__auto__)){
return or__8762__auto__;
} else {
...
var G__30911 = r.toPrecision((3));
return parseFloat(G__30911);
});
