...
schema.spec.leaf.LeafSpec.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__9452__auto__,k21087,else__9453__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k21087,else__9453__auto__);
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__21086){
var self__ = this;
var G__21086__$1 = this;
return (new cljs.core.RecordIter((0),G__21086__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$pre], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
});
...
var h__9218__auto____$1 = (function (){var fexpr__21092 = ((function (h__9218__auto__,this__9446__auto____$1){
...
;
return fexpr__21092(this__9446__auto____$1);
})();
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this21088,other21089){
var self__ = this;
var this21088__$1 = this;
return (!((other21089 == null))) && ((this21088__$1.constructor === other21089.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21088__$1.pre,other21089.pre)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this21088__$1.__extmap,other21089.__extmap));
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__9457__auto__,k__9458__auto__,G__21086){
var self__ = this;
var this__9457__auto____$1 = this;
var pred__21093 = cljs.core.keyword_identical_QMARK_;
var expr__21094 = k__9458__auto__;
if(cljs.core.truth_((function (){var G__21096 = cljs.core.cst$kw$pre;
var G__21097 = expr__21094;
return (pred__21093.cljs$core$IFn$_invoke$arity$2 ? pred__21093.cljs$core$IFn$_invoke$arity$2(G__21096,G__21097) : pred__21093.call(null,G__21096,G__21097));
})())){
return (new schema.spec.leaf.LeafSpec(G__21086,self__.__meta,self__.__extmap,null));
} else {
return (new schema.spec.leaf.LeafSpec(self__.pre,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__9458__auto__,G__21086),null));
}
});
...
schema.spec.leaf.LeafSpec.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__9449__auto__,G__21086){
var self__ = this;
var this__9449__auto____$1 = this;
return (new schema.spec.leaf.LeafSpec(self__.pre,G__21086,self__.__extmap,self__.__hash));
});
...
schema.spec.leaf.map__GT_LeafSpec = (function schema$spec$leaf$map__GT_LeafSpec(G__21090){
return (new schema.spec.leaf.LeafSpec(cljs.core.cst$kw$pre.cljs$core$IFn$_invoke$arity$1(G__21090),null,cljs.core.not_empty(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__21090,cljs.core.cst$kw$pre)),null));
});
